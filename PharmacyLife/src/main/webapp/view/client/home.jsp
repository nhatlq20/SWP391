                ...
                <body>
                    <%@ include file="../common/header.jsp" %>
                        ...
                        <!--                        <nav class="nav-categories">
                            <ul>
                                <li><a href="#bestsellers" class="active">Sản phẩm bán chạy nhất</a></li>
                                <li><a href="#featured-categories">Danh mục nổi bật</a></li>
                                <li><a href="#favorite-brands">Thương hiệu yêu thích</a></li>
                                <li><a href="#health-corner">Góc sức khỏe</a></li>
                                <li><a href="#cardio">Thuốc tim mạch</a></li>
                                <li><a href="#supplements">Thuốc bổ &amp; vitamin</a></li>
                                <li><a href="#today-featured">Sản phẩm nổi bật hôm nay</a></li>
                            </ul>
                        </nav>-->
                                ...
                                <div class="container">
                                    ...
                                    <div class="bestseller-grid">
                                        <c:if test="${not empty bestSellers}">
                                            <c:forEach var="m" items="${bestSellers}" varStatus="vs" begin="0" end="4">
                                                <div class="bestseller-premium-card">
                                                        ...
                                                        <c:choose>
                                                            <c:when test="${not empty m.imageUrl}">
                                                                ...
                                                                <c:choose>
                                                                    ...
                                                                    <c:when test="${fn:contains(url, 'assets/img')}">
                                                                        <c:set var="imgSrc"
                                                                            value="${pageContext.request.contextPath}/${url}" />
                                                                    </c:when>
                                                                    <c:otherwise>
                                                    ...
                                                    <div class="card-info-wrapper">
                                                        ...
                                                        <div class="premium-card-attribute">${m.unit}</div>
                        ...
                        <%@ include file="../common/footer.jsp" %>
                            ...
                            <script>
                                ...
                                // Find the card image for animation
                                ...
                                fetch('${pageContext.request.contextPath}/cart', {
                                    ...
                                    .then(data => {
                                        if (data.success) {
                                            ...
                                            // Update cart count with slight delay for animation
