                ...
                <div class="row g-5">
                    ...
                    <div class="col-12 col-lg-8 product-info-section">
                        ...
                        <div class="action-buttons">
                            <button class="btn-buy btn btn-primary">Chọn mua</button>
                ...
                <div class="review-section">
                    ...
                    <div class="review-item">
                        <div class="review-header">
                            ...
                            <div class="review-user-info">
                                <div class="review-name">Kiên trình</div>
                                <div class="review-role">Người mua thường xuyên</div>
                            </div>
                        ...
                        <p class="review-text">Sản phẩm tốt, chất lượng cao, giao hàng nhanh</p>
                    </div>
                    ...
                    <div class="review-item">
                        <div class="review-header">
                            ...
                            <div class="review-user-info">
                                <div class="review-name">Phạn Nhật Cường</div>
                                <div class="review-role">Người bán</div>
                            </div>
                        </div>
                        <p class="review-text" style="color: #3B6FD9; font-weight: 600;">Đúng rồi</p>
                    </div>
                </div>
            </div>
        </div>
