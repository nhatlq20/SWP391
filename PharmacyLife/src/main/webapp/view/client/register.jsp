                ...
                <form action="${pageContext.request.contextPath}/register" method="post">
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-wrapper">
                            ...
                            <img src="${pageContext.request.contextPath}/assets/img/emaillogin.png" alt="Name Icon" class="input-icon">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-wrapper">
                            ...
                            <img src="${pageContext.request.contextPath}/assets/img/phonereg.png" alt="Phone Icon" class="input-icon">
                        </div>
                    </div>
