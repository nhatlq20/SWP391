<%@page contentType="text/html" pageEncoding="UTF-8" %>
    <div class="sidebar">
        <ul class="sidebar-menu">
            ...
            <li><a href="${pageContext.request.contextPath}/category"><span style="font-size: 18px;">📊</span> Quản lí
                    danh mục</a></li>
            <li><a href="#"><span style="font-size: 18px;">✓</span> Quản lí đơn hàng</a></li>
            <li><a href="${pageContext.request.contextPath}/import" class="active"><span
                        style="font-size: 18px;">📥</span> Quản lí nhập thuốc</a></li>
            ...
            <li class="logout-link"><a href="#"><span style="font-size: 18px; color: #dc3545;">→</span> Đăng xuất</a>
            </li>
        </ul>
    </div>