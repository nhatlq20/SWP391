                                        ...
                                        <div class="import-flex-content">
                                            ...
                                            <div class="left-panel">
                                                <div class="custom-input-group">
                                                    ...
                                                    <input type="text" class="custom-input" value="${importRecord.importCode}" readonly style="background-color: #f0f0f0; cursor: not-allowed;">
                                                </div>
                                                ...
                                                <div class="custom-input-group">
                                                    ...
                                                    <select name="supplierId" class="custom-input" required>
                                                        ...
                                                        <c:forEach var="supplier" items="${suppliers}">
                                                            <option value="${supplier[0]}" ${supplier[0]==importRecord.supplierId ? 'selected' : ''}>${supplier[1]}</option>
                                                        </c:forEach>
                                                    </select>
                                                </div>
                                                ...
                                                <div class="custom-input-group">
                                                    ...
                                                    <input type="date" name="importDate" class="custom-input" required value="<fmt:formatDate value='${importRecord.importDate}' pattern='yyyy-MM-dd'/>">
                                                </div>

                                                <div class="custom-input-group">
                                                    <label class="custom-input-label">Người nhập</label>
                                                    <input type="text" class="custom-input" value="${importRecord.staffName}" readonly style="background-color: #f0f0f0; cursor: not-allowed;">
                                                ...
                                                <div class="custom-input-group">
                                                    ...
                                                    <select name="status" class="custom-input">
                                                        <option value="Đang chờ" ${importRecord.status=='Đang chờ' ? 'selected' : ''}>Đang chờ</option>
                                                        <option value="Chưa duyệt" ${importRecord.status=='Chưa duyệt' ? 'selected' : ''}>Chưa duyệt</option>
                                                        <option value="Đã duyệt" ${importRecord.status=='Đã duyệt' ? 'selected' : ''}>Đã duyệt</option>
                                                    </select>
                                                </div>

                                                <div class="total-amount-display">
                                                    Tổng tiền: <span class="amount-highlight" id="totalDisplay"><fmt:formatNumber value='${importRecord.totalAmount}' type='number' maxFractionDigits='0'/>₫</span>
                                                </div>
                                            </div>
                                                            ...
                                                            <c:when test="${not empty details}">
                                                                <c:forEach var="detail" items="${details}">
                                                                    <tr>
                                                                        ...
                                                                        <td class="price-text"><fmt:formatNumber value='${detail.unitPrice}' type='number' maxFractionDigits='0'/>₫</td>
                                                                        <td class="price-text"><fmt:formatNumber value='${detail.quantity * detail.unitPrice}' type='number' maxFractionDigits='0'/>₫</td>
                                                                        <td style="text-align: center;">
                                                                            <a href="${pageContext.request.contextPath}/ImportController?action=deleteDetail&detailId=${detail.detailId}&importId=${importRecord.importId}" onclick="return confirm('Xóa thuốc này?')" style="color: #dc3545; text-decoration: none;">
