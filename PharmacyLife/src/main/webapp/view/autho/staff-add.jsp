                        ...
                        <div class="staff-card" style="max-width: 600px; margin: 0 auto;">
                            <form method="POST" action="${pageContext.request.contextPath}/Staffmanage?action=insert"
                                    ...
                                    <label for="staffName">
                                        <span style="display:inline-flex; align-items:center; gap:4px;">
                                            <img src="${pageContext.request.contextPath}/assets/img/fname.png"
                                                alt="Name" style="width:20px; height:20px;" /> Họ và tên nhân viên
                                        </span>
                                    </label>
                                    ...
                                    <label for="staffEmail">
                                        <span style="display:inline-flex; align-items:center; gap:4px;">
                                            <img src="${pageContext.request.contextPath}/assets/img/email.png"
                                                alt="Email" style="width:20px; height:20px;" /> Email
                                        </span>
                                    </label>
                                    ...
                                    <label for="staffPassword">
                                        <span style="display:inline-flex; align-items:center; gap:4px;">
                                            <img src="${pageContext.request.contextPath}/assets/img/Lock.png"
                                                alt="Password" style="width:20px; height:20px;" /> Mật khẩu
                                        </span>
                                    </label>
                                ...
                                <div class="form-group">
                                    <label>
                                        <span style="display:inline-flex; align-items:center; gap:4px;">
                                            <img src="${pageContext.request.contextPath}/assets/img/role.png" alt="Role"
                                                style="width:20px; height:20px;" /> Chức vụ
                                        </span>
                                    </label>
                                    <div
                                        style="width:100%; padding:10px; background:#f5f5f5; border-radius:6px; font-size:14px; color:#666;">
                                        Nhân viên
                                    </div>
                                </div>
                                ...
                                <div class="form-actions"
                                    ...
                                    <button type="submit" class="btn-submit"
                                        style="padding:10px 28px; background:#4B9BFF; color:white; border:none; border-radius:18px; cursor:pointer; font-weight:600;">⊕
                                        Thêm</button>
                                </div>
