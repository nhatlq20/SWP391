                ...
                <body class="bg-light">
                    ...
                    <div class="main-content">
                        <div class="d-flex justify-content-between align-items-center mb-4">
                            <h3 class="fw-bold mb-0"><i class="fas fa-file-import me-2 text-primary"></i>Chi tiết phiếu
                                nhập</h3>
                        </div>
                                ...
                                <div class="form-card-body">
                                    ...
                                    <div class="info-grid">
                                        ...
                                        <div class="info-item">
                                            ...
                                            <div class="info-value">${importRecord.supplierName != null ?
                                                importRecord.supplierName : importRecord.supplierId}</div>
                                        </div>
                                        <div class="info-item">
                                            <div class="info-label">Người nhập</div>
                                            <div class="info-value">${importRecord.staffName != null ?
                                                importRecord.staffName : importRecord.staffId}</div>
                                        </div>
                                        <div class="info-item">
                                            <div class="info-label">Ngày nhập</div>
                                            <div class="info-value">
                                                <fmt:formatDate value="${importRecord.importDate}"
                                                    pattern="dd/MM/yyyy" />
                                            </div>
                                        </div>
                                        <div class="info-item">
                                        ...
                                        <div class="info-item">
                                            ...
                                            <div class="info-value">
                                                ...
                                                <c:if test="${importRecord.status == 'Đã duyệt'}">
                                                    <c:set var="statusClass" value="badge badge-confirmed" />
                                                </c:if>
                                                <c:if
                                                    test="${importRecord.status == 'Chưa duyệt' || importRecord.status == 'Đã hủy'}">
                                                    <c:set var="statusClass" value="badge badge-cancelled" />
                                                </c:if>
                                                <span class="${statusClass}">${importRecord.status != null ?
                                                    importRecord.status : 'Đang chờ'}</span>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <c:if test="${not empty details}">
                                        <div style="margin-top: 36px;">
                                            <h5 class="fw-bold mb-3" style="color: #1e293b; font-size: 1.1rem;"><i
                                                    class="fas fa-list me-2 text-primary"></i>Danh sách thuốc nhập</h5>
