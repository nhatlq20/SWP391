                                ...
                                <table class="table table-hover align-middle mb-0">
                                    ...
                                    <tbody>
                                        <c:choose>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="d-flex gap-1 justify-content-center">
                                                                ...
                                                                <c:if
                                                                    test="${sessionScope.userType eq 'staff' and fn:toLowerCase(fn:trim(sessionScope.roleName)) eq 'admin'}">
                                                                    <button class="btn-action btn-delete js-delete-btn"
                                                                        title="Xóa"
                                                                        data-href="category?action=delete&id=${c.categoryId}">
                                            ...
                                            <c:otherwise>
                                                <tr>
                                                    <td colspan="3" class="text-center py-4 text-muted">Không có danh
                                                        mục
                                                        nào.</td>
                                                </tr>
                                            </c:otherwise>
