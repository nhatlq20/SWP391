                                    ...
                                    <div class="table-responsive">
                                        <table class="table" id="usesTable" style="margin-bottom: 0; border: none;">
                                            ...
                                            <tbody>
                                                <tr style="border: none;">
                                                    <td style="border: none; padding: 0;"><input
                                                            class="form-control use-name" placeholder="Ví dụ: Đau đầu">
                                                    </td>
                                                    <td style="border: none; padding: 0 0 0 12px;"><input
                                                            class="form-control use-desc"
                                                            placeholder="Giảm đau nửa đầu..."></td>
                                                    <td style="border: none; padding: 0 0 0 12px;"><input
