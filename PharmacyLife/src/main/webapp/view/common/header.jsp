                ...
                <nav class="navbar header navbar-expand-lg">
                    <div class="container-fluid">
                        <a class="navbar-brand logo-link" href="${pageContext.request.contextPath}/home">
                            <div class="logo-text">
                                <span class="text-white">NHÀ THUỐC</span>
                                <br>
                                <span class="text-white">PHARMACY LIFE</span>
                            </div>
                        </a>
                        ...
                        <div class="collapse navbar-collapse" id="navbarSupportedContent">
                            ...
                            <ul class="navbar-nav ms-auto mb-2 mb-lg-0 align-items-center nav-right">
                                <li class="nav-item me-2">
                                    <a class="nav-link text-white" href="#"><i class="fas fa-user"
