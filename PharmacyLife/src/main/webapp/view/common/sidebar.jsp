            ...
            <div class="sidebar-wrapper">
                <div class="sidebar-menu">
                    ...
                    <a href="${pageContext.request.contextPath}/reviews"
                        class="sidebar-item ${fn:contains(uri, 'reviews') ? 'active' : ''}">
