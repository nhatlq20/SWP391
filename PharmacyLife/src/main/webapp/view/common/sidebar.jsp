...
<div class="sidebar-wrapper">
  <div class="sidebar-menu">
    ...
    <a
      href="${pageContext.request.contextPath}/my-reviews"
      class="sidebar-item ${fn:contains(uri, 'my-reviews') && !fn:contains(uri, 'dashboard') ? 'active' : ''}"
    >
    ...
    <hr />
    <div
      class="sidebar-heading text-muted small text-uppercase fw-bold mb-2 px-3"
    >
      Quản Trị Viên
    </div>
    ...
    <a
      href="${pageContext.request.contextPath}/admin/products-dashboard"
    ...
    <a
      href="${pageContext.request.contextPath}/admin/staff-dashboard"
    ...
    <a
      href="${pageContext.request.contextPath}/CategoryServlet?action=list"
      class="sidebar-item ${fn:contains(uri, 'CategoryServlet') || fn:contains(uri, 'category') ? 'active' : ''}"
    >
