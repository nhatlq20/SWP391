                ...
                <div class="row">
                    ...
                    <div class="col-lg-8">
                        <div class="checkout-container">
                            <h4 class="mb-4"><i class="fas fa-money-check-alt me-2"></i>Thông tin giao hàng</h4>
                            
                            <form action="checkout" method="POST">
                                <div class="row g-3">
                                    <div class="col-12">
                                        <label for="fullName" class="form-label required">Họ và tên</label>
                                        <input type="text" class="form-control" id="fullName" name="fullName" required placeholder="Nhập họ tên người nhận">
                                    </div>
                                    
                                    <div class="col-12">
                                        <label for="phone" class="form-label required">Số điện thoại</label>
                                        <input type="tel" class="form-control" id="phone" name="phone" required placeholder="Nhập số điện thoại liên hệ">
                                    </div>
                                    
                                    <div class="col-12">
                                        <label for="address" class="form-label required">Địa chỉ nhận hàng</label>
                                        <textarea class="form-control" id="address" name="address" rows="3" required placeholder="Nhập địa chỉ chi tiết (số nhà, đường, phường/xã...)"></textarea>
                                    </div>
                                    ...
                                    <div class="col-12 mt-4">
                                        <button class="btn btn-primary-custom w-100 py-3 fw-bold" type="submit">
                                            HOÀN TẤT ĐẶT HÀNG
                                        </button>
                    ...
                    <div class="col-lg-4">
                        <div class="order-summary shadow-sm sticky-top" style="top: 130px;">
                            ...
                            <div class="d-flex justify-content-between mb-2">
                                <span>Tạm tính</span>
                                <strong><fmt:formatNumber value="${totalMoney}" type="currency" currencySymbol="₫" maxFractionDigits="0"/></strong>
                            </div>
                            ...
                            <div class="d-flex justify-content-between">
                                ...
                                <span class="h5 mb-0 text-danger fw-bold">
                                    <fmt:formatNumber value="${totalMoney}" type="currency" currencySymbol="₫" maxFractionDigits="0"/>
                                </span>
                            </div>
                        </div>
                    </div>
